...
@jitclass([
    ...
    ("d_to_n_p_derived", numba.float64),
    ("t_to_n_d_derived", numba.float64),
    ("He3_to_p_d_derived", numba.float64),
    ("He4_to_d_d_derived", numba.float64),
    ("Li6_to_He4_d_derived", numba.float64),
    ("He4_to_p_t_derived", numba.float64),
    ("Li7_to_He4_t_derived", numba.float64),
    ("He4_to_n_He3_derived", numba.float64),
    ("Be7_to_He4_He3_derived", numba.float64),
    ("Li7_to_n_Li6_derived", numba.float64),
    ("Be7_to_p_Li6_derived", numba.float64),
    ("n_He3_to_d_d_derived", numba.float64),
    ("p_t_to_d_d_derived", numba.float64),
    ("n_He4_to_d_t_derived", numba.float64),
    ("p_t_to_n_He3_derived", numba.float64),
    ("p_He4_to_d_He3_derived", numba.float64),
    ("d_He4_to_t_He3_derived", numba.float64),
    ("He4_t_to_n_Li6_derived", numba.float64),
    ("He4_He3_to_p_Li6_derived", numba.float64),
    ("n_Be7_to_d_Li6_derived", numba.float64),
    ("p_Li7_to_d_Li6_derived", numba.float64),
    ("He4_He4_to_p_Li7_derived", numba.float64),
    ("p_Li7_to_n_Be7_derived", numba.float64),
    ("He4_He4_to_n_Be7_derived", numba.float64),
    ("n_n_He4_to_t_t_derived", numba.float64),
    ("n_p_He4_to_t_He3_derived", numba.float64),
    ("p_p_He4_to_He3_He3_derived", numba.float64),
    ("n_He4_He4_to_d_Li7_derived", numba.float64),
    ("p_He4_He4_to_d_Be7_derived", numba.float64),
    ("n_n_He4_He4_to_t_Li7_derived", numba.float64),
    ("n_p_He4_He4_to_He3_Li7_derived", numba.float64),
    ("n_p_He4_He4_to_t_Be7_derived", numba.float64),
    ("p_p_He4_He4_to_He3_Be7_derived", numba.float64),
    ("Li6_to_n_p_He4_derived", numba.float64),
    ("p_d_to_n_p_p_derived", numba.float64),
])
class RateEval:
    def __init__(self):
        ...
        self.d_to_n_p_derived = np.nan
        self.t_to_n_d_derived = np.nan
        self.He3_to_p_d_derived = np.nan
        self.He4_to_d_d_derived = np.nan
        self.Li6_to_He4_d_derived = np.nan
        self.He4_to_p_t_derived = np.nan
        self.Li7_to_He4_t_derived = np.nan
        self.He4_to_n_He3_derived = np.nan
        self.Be7_to_He4_He3_derived = np.nan
        self.Li7_to_n_Li6_derived = np.nan
        self.Be7_to_p_Li6_derived = np.nan
        self.n_He3_to_d_d_derived = np.nan
        self.p_t_to_d_d_derived = np.nan
        self.n_He4_to_d_t_derived = np.nan
        self.p_t_to_n_He3_derived = np.nan
        self.p_He4_to_d_He3_derived = np.nan
        self.d_He4_to_t_He3_derived = np.nan
        self.He4_t_to_n_Li6_derived = np.nan
        self.He4_He3_to_p_Li6_derived = np.nan
        self.n_Be7_to_d_Li6_derived = np.nan
        self.p_Li7_to_d_Li6_derived = np.nan
        self.He4_He4_to_p_Li7_derived = np.nan
        self.p_Li7_to_n_Be7_derived = np.nan
        self.He4_He4_to_n_Be7_derived = np.nan
        self.n_n_He4_to_t_t_derived = np.nan
        self.n_p_He4_to_t_He3_derived = np.nan
        self.p_p_He4_to_He3_He3_derived = np.nan
        self.n_He4_He4_to_d_Li7_derived = np.nan
        self.p_He4_He4_to_d_Be7_derived = np.nan
        self.n_n_He4_He4_to_t_Li7_derived = np.nan
        self.n_p_He4_He4_to_He3_Li7_derived = np.nan
        self.n_p_He4_He4_to_t_Be7_derived = np.nan
        self.p_p_He4_He4_to_He3_Be7_derived = np.nan
        self.Li6_to_n_p_He4_derived = np.nan
        self.p_d_to_n_p_p_derived = np.nan
...
@numba.njit()
def d_to_n_p_derived(rate_eval, tf, log_scor=0.0):
    # d --> n + p

    # Assume no partition function effects
    net_log_pf = 0.0
    rate = 0.0

    # an06n
    ln_set_rate =  34.65276099032698 + -25.815019581199707*tf.T9i + -2.70618*tf.T913 \
                         + 0.11718*tf.T9 + -0.00312788*tf.T953 + 1.969127*tf.lnT9
    ...
    # an06n
    ln_set_rate =  33.03886099032698 + -25.815019581199707*tf.T9i + -2.30472*tf.T913 \
    ...
    # an06n
    ln_set_rate =  31.130940990326984 + -25.815019581199707*tf.T9i + -0.0102082*tf.T913 \
    ...
    rate_eval.d_to_n_p_derived = rate

@numba.njit()
def t_to_n_d_derived(rate_eval, tf, log_scor=0.0):
    # t --> n + d
    ...
    # nk06n
    ln_set_rate =  30.138169862343933 + -72.61214002813374*tf.T9i \
                         + 2.5*tf.lnT9
    ...
    # nk06n
    ln_set_rate =  28.894799862343934 + -72.61214002813374*tf.T9i \
                         + 1.575*tf.lnT9
    ...
    rate_eval.t_to_n_d_derived = rate

@numba.njit()
def He3_to_p_d_derived(rate_eval, tf, log_scor=0.0):
    # He3 --> p + d
    ...
    # de04 
    ln_set_rate =  32.462003866933586 + -63.74913110454079*tf.T9i + -3.7208*tf.T913i + 0.198654*tf.T913 \
                         + 1.833333*tf.lnT9
    ...
    # de04n
    ln_set_rate =  31.055733866933583 + -63.74913110454079*tf.T9i + -3.7208*tf.T913i + 0.871782*tf.T913 \
                         + 0.833333*tf.lnT9
...
@numba.njit()
def He4_to_d_d_derived(rate_eval, tf, log_scor=0.0):
    # He4 --> d + d
    ...
    # nacrn
    ln_set_rate =  28.331961272809913 + -276.72748859272605*tf.T9i + -4.26166*tf.T913i + -0.119233*tf.T913 \
...
@numba.njit()
def Li6_to_He4_d_derived(rate_eval, tf, log_scor=0.0):
    # Li6 --> He4 + d
    ...
    # tu19r
    ln_set_rate =  27.580161349491974 + -24.991255653425394*tf.T9i
    ...
    # tu19n
    ln_set_rate =  22.780546349491974 + -17.102191742425394*tf.T9i + -7.55198*tf.T913i + 5.77546*tf.T913 \
                         + -0.487854*tf.T9 + 0.032833*tf.T953 + 0.3769499999999999*tf.lnT9

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.Li6_to_He4_d_derived = rate

@numba.njit()
def He4_to_p_t_derived(rate_eval, tf, log_scor=0.0):
    # He4 --> p + t
    ...
    # cf88n
    ln_set_rate =  33.76383958135291 + -229.93036814578724*tf.T9i + -3.869*tf.T913i + 1.45482*tf.T913 \
    ...
    rate_eval.He4_to_p_t_derived = rate

@numba.njit()
def Li7_to_He4_t_derived(rate_eval, tf, log_scor=0.0):
    # Li7 --> He4 + t
    ...
    # de04 
    ln_set_rate =  36.75341348198556 + -28.635561547099176*tf.T9i + -8.0805*tf.T913i + -0.217514*tf.T913 \
    ...
    rate_eval.Li7_to_He4_t_derived = rate

@numba.njit()
def He4_to_n_He3_derived(rate_eval, tf, log_scor=0.0):
    # He4 --> n + He3
    ...
    # ka02n
    ln_set_rate =  33.046365576763264 + -238.793377069385*tf.T9i + -1.50147*tf.T913 \
                         + 2.5*tf.lnT9
    ...
    # ka02n
    ln_set_rate =  29.51775557676326 + -238.793377069385*tf.T9i \
                         + 1.5*tf.lnT9
    ...
    rate_eval.He4_to_n_He3_derived = rate

@numba.njit()
def Be7_to_He4_He3_derived(rate_eval, tf, log_scor=0.0):
    # Be7 --> He4 + He3
    ...
    # cd08n
    ln_set_rate =  40.84436725519251 + -18.41793396772273*tf.T9i + -12.8271*tf.T913i + -3.8126*tf.T913 \
    ...
    # cd08n
    ln_set_rate =  38.74676725519251 + -18.41793396772273*tf.T9i + -12.8271*tf.T913i + -0.0308225*tf.T913 \
...
@numba.njit()
def Li7_to_n_Li6_derived(rate_eval, tf, log_scor=0.0):
    # Li7 --> n + Li6
    ...
    # jz10n
    ln_set_rate =  32.256821994837516 + -84.14544592180752*tf.T9i \
                         + 1.5*tf.lnT9
    ...
    rate_eval.Li7_to_n_Li6_derived = rate

@numba.njit()
def Be7_to_p_Li6_derived(rate_eval, tf, log_scor=0.0):
    # Be7 --> p + Li6
    ...
    # nacrn
    ln_set_rate =  37.48578977263412 + -65.06480941882852*tf.T9i + -8.4372*tf.T913i + -0.515473*tf.T913 \
    ...
    rate_eval.Be7_to_p_Li6_derived = rate

@numba.njit()
def n_He3_to_d_d_derived(rate_eval, tf, log_scor=0.0):
    # He3 + n --> d + d
    ...
    # gi17n
    ln_set_rate =  19.63714569604665 + -37.934301543336275*tf.T9i + -4.2292*tf.T913i + 1.6932*tf.T913 \
                         + -0.0855529*tf.T9 + -1.35709e-25*tf.T953 + -0.734513*tf.lnT9
    ...
    rate_eval.n_He3_to_d_d_derived = rate

@numba.njit()
def p_t_to_d_d_derived(rate_eval, tf, log_scor=0.0):
    # t + p --> d + d
    ...
    # go17n
    ln_set_rate =  19.356811691457004 + -46.79707682603883*tf.T9i + -4.32296*tf.T913i + 1.91572*tf.T913 \
                         + -0.081562*tf.T9 + -3.28804e-22*tf.T953 + -0.879518*tf.lnT9
    ...
    rate_eval.p_t_to_d_d_derived = rate

@numba.njit()
def n_He4_to_d_t_derived(rate_eval, tf, log_scor=0.0):
    # n + He4 --> d + t
    ...
    # de04 
    ln_set_rate =  41.06021859102593 + -204.11534856459232*tf.T9i + -4.5244*tf.T913i + -16.4028*tf.T913 \
                         + 1.73103*tf.T9 + -0.122966*tf.T953 + 2.31304*tf.lnT9
    ...
    # de04 
    ln_set_rate =  26.89391859102593 + -204.11534856459232*tf.T9i + -4.5244*tf.T913i + 0.350337*tf.T913 \
                         + 0.58747*tf.T9 + -8.84909*tf.T953 + -0.666667*tf.lnT9
    ...
    rate_eval.n_He4_to_d_t_derived = rate

@numba.njit()
def p_t_to_n_He3_derived(rate_eval, tf, log_scor=0.0):
    # t + p --> n + He3
    ...
    # de04 
    ln_set_rate =  19.27826599541035 + -8.863008923597755*tf.T9i + 0.0438557*tf.T913 \
                         + -0.201527*tf.T9 + 0.0153433*tf.T953 + 1.0*tf.lnT9
    ...
    # de04 
    ln_set_rate =  20.38076599541035 + -8.863008923597755*tf.T9i + -0.332788*tf.T913 \
                         + -0.700485*tf.T9 + 0.0976521*tf.T953
    ...
    rate_eval.p_t_to_n_He3_derived = rate

@numba.njit()
def p_He4_to_d_He3_derived(rate_eval, tf, log_scor=0.0):
    # p + He4 --> d + He3
    ...
    # de04 
    ln_set_rate =  43.013484586436284 + -212.97835748819008*tf.T9i + -7.182*tf.T913i + -17.1349*tf.T913 \
                         + 1.36908*tf.T9 + -0.0814423*tf.T953 + 3.35395*tf.lnT9
    ...
    # de04 
    ln_set_rate =  26.40048458643628 + -212.97835748819008*tf.T9i + -7.182*tf.T913i + 0.473288*tf.T913 \
                         + 1.46847*tf.T9 + -27.9603*tf.T953 + -0.666667*tf.lnT9
...
@numba.njit()
def d_He4_to_t_He3_derived(rate_eval, tf, log_scor=0.0):
    # d + He4 --> t + He3
    ...
    # cf88n
    ln_set_rate =  22.892525714419328 + -166.18123704124648*tf.T9i + -7.733*tf.T913i + -0.133473*tf.T913 \
                         + -0.294412*tf.T9 + 0.0310968*tf.T953 + -0.666667*tf.lnT9
    ...
    rate_eval.d_He4_to_t_He3_derived = rate

@numba.njit()
def He4_t_to_n_Li6_derived(rate_eval, tf, log_scor=0.0):
    # t + He4 --> n + Li6
    ...
    # cf88r
    ln_set_rate =  21.73678851285196 + -57.901164374708344*tf.T9i \
                         + -1.5*tf.lnT9
    ...
    # cf88n
    ln_set_rate =  19.02138851285196 + -55.51116537470834*tf.T9i

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.He4_t_to_n_Li6_derived = rate

@numba.njit()
def He4_He3_to_p_Li6_derived(rate_eval, tf, log_scor=0.0):
    # He3 + He4 --> p + Li6
    ...
    # pt05n
    ln_set_rate =  24.417222517441605 + -46.646875451105785*tf.T9i + -8.39481*tf.T913i + -0.165254*tf.T913 \
                         + -0.16936*tf.T9 + 0.0533676*tf.T953 + -0.666667*tf.lnT9
    ...
    rate_eval.He4_He3_to_p_Li6_derived = rate

@numba.njit()
def n_Be7_to_d_Li6_derived(rate_eval, tf, log_scor=0.0):
    # Be7 + n --> d + Li6
    ...
    # mafon
    ln_set_rate =  28.93202878230714 + -39.249789837633585*tf.T9i + -10.259*tf.T913i + -2.01559e-09*tf.T913 \
                         + 1.99542e-10*tf.T9 + -1.65595e-11*tf.T953 + -0.666667*tf.lnT9
    ...
    rate_eval.n_Be7_to_d_Li6_derived = rate

@numba.njit()
def p_Li7_to_d_Li6_derived(rate_eval, tf, log_scor=0.0):
    # Li7 + p --> d + Li6
    ...
    # mafon
    ln_set_rate =  28.948041004510536 + -58.33042634060782*tf.T9i + -10.135*tf.T913i \
                         + -0.666667*tf.lnT9
    ...
    rate_eval.p_Li7_to_d_Li6_derived = rate

@numba.njit()
def He4_He4_to_p_Li7_derived(rate_eval, tf, log_scor=0.0):
    # He4 + He4 --> p + Li7
    ...
    # de04r
    ln_set_rate =  23.454413279927294 + -227.4475065986905*tf.T9i \
                         + -1.5*tf.lnT9
    ...
    # de04 
    ln_set_rate =  21.998313279927295 + -201.29480659869049*tf.T9i + -8.4727*tf.T913i + 0.297934*tf.T913 \
                         + 0.0582335*tf.T9 + -0.00413383*tf.T953 + -0.666667*tf.lnT9
    ...
    # de04r
    ln_set_rate =  15.808313279927294 + -205.7728065986905*tf.T9i \
                         + -1.5*tf.lnT9
    ...
    # de04 
    ln_set_rate =  13.512113279927293 + -201.29480659869049*tf.T9i + -8.4727*tf.T913i + 0.417943*tf.T913 \
                         + 5.34565*tf.T9 + -4.8684*tf.T953 + -0.666667*tf.lnT9
...
@numba.njit()
def p_Li7_to_n_Be7_derived(rate_eval, tf, log_scor=0.0):
    # Li7 + p --> n + Be7
    ...
    # db18 
    ln_set_rate =  21.792312222203396 + -19.079908404979005*tf.T9i + -0.30254*tf.T913i + -0.3602*tf.T913 \
                         + 0.17472*tf.T9 + -0.0223*tf.T953 + -0.4581*tf.lnT9
    ...
    rate_eval.p_Li7_to_n_Be7_derived = rate

@numba.njit()
def He4_He4_to_n_Be7_derived(rate_eval, tf, log_scor=0.0):
    # He4 + He4 --> n + Be7
    ...
    #  wagn
    ln_set_rate =  19.718325502130693 + -220.37544310166703*tf.T9i + -0.00210045*tf.T913 \
                         + 0.000176541*tf.T9 + -1.36797e-05*tf.T953 + 1.00083*tf.lnT9
    ...
    rate_eval.He4_He4_to_n_Be7_derived = rate

@numba.njit()
def n_n_He4_to_t_t_derived(rate_eval, tf, log_scor=0.0):
    # n + n + He4 --> t + t
    ...
    # cf88r
    ln_set_rate =  -0.5782012713180009 + -131.503208536449*tf.T9i + -4.872*tf.T913i + -1.72398*tf.T913 \
                         + 0.684775*tf.T9 + -0.0702582*tf.T953 + -1.166667*tf.lnT9
    ...
    # cf88n
    ln_set_rate =  -0.5782012713180009 + -131.503208536449*tf.T9i + -4.872*tf.T913i + -0.0328579*tf.T913 \
                         + -1.13588*tf.T9 + 0.250064*tf.T953 + -2.166667*tf.lnT9

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.n_n_He4_to_t_t_derived = rate

@numba.njit()
def n_p_He4_to_t_He3_derived(rate_eval, tf, log_scor=0.0):
    # n + p + He4 --> t + He3
    ...
    # cf88n
    ln_set_rate =  0.9535647240923488 + -140.36621746005633*tf.T9i + -7.733*tf.T913i + -0.118902*tf.T913 \
                         + -0.267393*tf.T9 + 0.0275387*tf.T953 + -2.166667*tf.lnT9

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.n_p_He4_to_t_He3_derived = rate

@numba.njit()
def p_p_He4_to_He3_He3_derived(rate_eval, tf, log_scor=0.0):
    # p + p + He4 --> He3 + He3
    ...
    # nacrn
    ln_set_rate =  2.968630719502702 + -149.22922638364452*tf.T9i + -12.277*tf.T913i + -0.103699*tf.T913 \
...
@numba.njit()
def n_He4_He4_to_d_Li7_derived(rate_eval, tf, log_scor=0.0):
    # n + He4 + He4 --> d + Li7
    ...
    # cf88n
    ln_set_rate =  5.670452289600313 + -175.47978701748355*tf.T9i + -10.259*tf.T913i \
                         + -2.166667*tf.lnT9
    ...
    rate_eval.n_He4_He4_to_d_Li7_derived = rate

@numba.njit()
def p_He4_He4_to_d_Be7_derived(rate_eval, tf, log_scor=0.0):
    # p + He4 + He4 --> d + Be7
    ...
    # cf88n
    ln_set_rate =  6.9715645118037095 + -194.56042352046737*tf.T9i + -12.428*tf.T913i \
                         + -2.166667*tf.lnT9
...
@numba.njit()
def n_n_He4_He4_to_t_Li7_derived(rate_eval, tf, log_scor=0.0):
    # n + n + He4 + He4 --> t + Li7
    ...
    # mafon
    ln_set_rate =  -16.060920392183675 + -102.86764698936473*tf.T9i + -11.333*tf.T913i + -2.24192e-09*tf.T913 \
                         + 2.21773e-10*tf.T9 + -1.83941e-11*tf.T953 + -3.666667*tf.lnT9

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.n_n_He4_He4_to_t_Li7_derived = rate

@numba.njit()
def n_p_He4_He4_to_He3_Li7_derived(rate_eval, tf, log_scor=0.0):
    # n + p + He4 + He4 --> He3 + Li7
    ...
    # mafon
    ln_set_rate =  -14.218301577333268 + -111.73065591294703*tf.T9i + -17.989*tf.T913i + -1.57523e-09*tf.T913 \
                         + 1.45934e-10*tf.T9 + -1.15341e-11*tf.T953 + -3.666667*tf.lnT9

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.n_p_He4_He4_to_He3_Li7_derived = rate

@numba.njit()
def n_p_He4_He4_to_t_Be7_derived(rate_eval, tf, log_scor=0.0):
    # n + p + He4 + He4 --> t + Be7
    ...
    # mafon
    ln_set_rate =  -15.556755350540218 + -121.94828349233572*tf.T9i + -13.792*tf.T913i + -2.92021e-09*tf.T913 \
                         + 2.89378e-10*tf.T9 + -2.40287e-11*tf.T953 + -3.666667*tf.lnT9

    ln_set_rate += net_log_pf + log_scor
    set_rate = np.exp(ln_set_rate)
    rate += set_rate

    rate_eval.n_p_He4_He4_to_t_Be7_derived = rate

@numba.njit()
def p_p_He4_He4_to_He3_Be7_derived(rate_eval, tf, log_scor=0.0):
    # p + p + He4 + He4 --> He3 + Be7
    ...
    # mafon
    ln_set_rate =  -11.817242174569923 + -130.81129241593683*tf.T9i + -21.793*tf.T913i + -1.98126e-09*tf.T913 \
...
@numba.njit()
def Li6_to_n_p_He4_derived(rate_eval, tf, log_scor=0.0):
    # Li6 --> n + p + He4
    ...
    # cf88r
    ln_set_rate =  33.455992339818955 + -62.27027523462029*tf.T9i + 1.44987*tf.T913i + -1.42759*tf.T913 \
    ...
    rate_eval.Li6_to_n_p_He4_derived = rate

@numba.njit()
def p_d_to_n_p_p_derived(rate_eval, tf, log_scor=0.0):
    # d + p --> n + p + p
    ...
    # cf88n
    ln_set_rate =  17.350573809767035 + -25.815019581194903*tf.T9i + -3.72*tf.T913i + 0.946313*tf.T913 \
    ...
    rate_eval.p_d_to_n_p_p_derived = rate
...
def do_rate_eval(t, Y, rho, T, screen_func):
    ...
    if screen_func is not None:
        ...
        scn_fac = ScreenFactors(2, 2, 2, 4)
        log_scor_He2_He4 = screen_func(plasma_state, scn_fac)
        ...
        scn_fac = ScreenFactors(2, 2, 4, 8)
        log_scor_He2_Be8 = screen_func(plasma_state, scn_fac)
    ...
    # derived rates
    d_to_n_p_derived(rate_eval, tf)
    t_to_n_d_derived(rate_eval, tf)
    He3_to_p_d_derived(rate_eval, tf)
    He4_to_d_d_derived(rate_eval, tf)
    Li6_to_He4_d_derived(rate_eval, tf)
    He4_to_p_t_derived(rate_eval, tf)
    Li7_to_He4_t_derived(rate_eval, tf)
    He4_to_n_He3_derived(rate_eval, tf)
    Be7_to_He4_He3_derived(rate_eval, tf)
    Li7_to_n_Li6_derived(rate_eval, tf)
    Be7_to_p_Li6_derived(rate_eval, tf)
    n_He3_to_d_d_derived(rate_eval, tf)
    p_t_to_d_d_derived(rate_eval, tf, log_scor=log_scor_p_t)
    n_He4_to_d_t_derived(rate_eval, tf)
    p_t_to_n_He3_derived(rate_eval, tf, log_scor=log_scor_p_t)
    p_He4_to_d_He3_derived(rate_eval, tf, log_scor=log_scor_p_He4)
    d_He4_to_t_He3_derived(rate_eval, tf, log_scor=log_scor_d_He4)
    He4_t_to_n_Li6_derived(rate_eval, tf, log_scor=log_scor_t_He4)
    He4_He3_to_p_Li6_derived(rate_eval, tf, log_scor=log_scor_He3_He4)
    n_Be7_to_d_Li6_derived(rate_eval, tf)
    p_Li7_to_d_Li6_derived(rate_eval, tf, log_scor=log_scor_p_Li7)
    He4_He4_to_p_Li7_derived(rate_eval, tf, log_scor=log_scor_He4_He4)
    p_Li7_to_n_Be7_derived(rate_eval, tf, log_scor=log_scor_p_Li7)
    He4_He4_to_n_Be7_derived(rate_eval, tf, log_scor=log_scor_He4_He4)
    n_n_He4_to_t_t_derived(rate_eval, tf)
    n_p_He4_to_t_He3_derived(rate_eval, tf, log_scor=log_scor_p_He4)
    p_p_He4_to_He3_He3_derived(rate_eval, tf, log_scor=log_scor_p_p + log_scor_He2_He4)
    n_He4_He4_to_d_Li7_derived(rate_eval, tf, log_scor=log_scor_He4_He4)
    p_He4_He4_to_d_Be7_derived(rate_eval, tf, log_scor=log_scor_He4_He4 + log_scor_p_Be8)
    n_n_He4_He4_to_t_Li7_derived(rate_eval, tf, log_scor=log_scor_He4_He4)
    n_p_He4_He4_to_He3_Li7_derived(rate_eval, tf, log_scor=log_scor_He4_He4 + log_scor_p_Be8)
    n_p_He4_He4_to_t_Be7_derived(rate_eval, tf, log_scor=log_scor_He4_He4 + log_scor_p_Be8)
    p_p_He4_He4_to_He3_Be7_derived(rate_eval, tf, log_scor=log_scor_He4_He4 + log_scor_p_p + log_scor_He2_Be8)
    Li6_to_n_p_He4_derived(rate_eval, tf)
    p_d_to_n_p_p_derived(rate_eval, tf, log_scor=log_scor_p_d)
...
def rhs_eq(t, Y, rho, T, screen_func):
    ...
    dYdt[jn] = (
          ...
          ( -rho*Y[jn]*Y[jp]*rate_eval.n_p_to_d_reaclib +Y[jd]*rate_eval.d_to_n_p_derived ) +
          ( -rho*Y[jn]*Y[jd]*rate_eval.n_d_to_t_reaclib +Y[jt]*rate_eval.t_to_n_d_derived ) +
          ( -rho*Y[jn]*Y[jhe3]*rate_eval.n_He3_to_He4_reaclib +Y[jhe4]*rate_eval.He4_to_n_He3_derived ) +
          ( -rho*Y[jn]*Y[jli6]*rate_eval.n_Li6_to_Li7_reaclib +Y[jli7]*rate_eval.Li7_to_n_Li6_derived ) +
          ( +5.00000000000000e-01*rho*Y[jd]**2*rate_eval.d_d_to_n_He3_reaclib -rho*Y[jn]*Y[jhe3]*rate_eval.n_He3_to_d_d_derived ) +
          ( +rho*Y[jd]*Y[jt]*rate_eval.d_t_to_n_He4_reaclib -rho*Y[jn]*Y[jhe4]*rate_eval.n_He4_to_d_t_derived ) +
          ( -rho*Y[jn]*Y[jhe3]*rate_eval.n_He3_to_p_t_reaclib +rho*Y[jp]*Y[jt]*rate_eval.p_t_to_n_He3_derived ) +
          ( -rho*Y[jn]*Y[jli6]*rate_eval.n_Li6_to_He4_t_reaclib +rho*Y[jt]*Y[jhe4]*rate_eval.He4_t_to_n_Li6_derived ) +
          ( +rho*Y[jd]*Y[jli6]*rate_eval.d_Li6_to_n_Be7_reaclib -rho*Y[jn]*Y[jbe7]*rate_eval.n_Be7_to_d_Li6_derived ) +
          ( -rho*Y[jn]*Y[jbe7]*rate_eval.n_Be7_to_p_Li7_reaclib +rho*Y[jp]*Y[jli7]*rate_eval.p_Li7_to_n_Be7_derived ) +
          ( -rho*Y[jn]*Y[jbe7]*rate_eval.n_Be7_to_He4_He4_reaclib +5.00000000000000e-01*rho*Y[jhe4]**2*rate_eval.He4_He4_to_n_Be7_derived ) +
          ( + 2*5.00000000000000e-01*rho*Y[jt]**2*rate_eval.t_t_to_n_n_He4_reaclib + -2*5.00000000000000e-01*rho**2*Y[jn]**2*Y[jhe4]*rate_eval.n_n_He4_to_t_t_derived ) +
          ( +rho*Y[jt]*Y[jhe3]*rate_eval.t_He3_to_n_p_He4_reaclib -rho**2*Y[jn]*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived ) +
          ( +rho*Y[jd]*Y[jli7]*rate_eval.d_Li7_to_n_He4_He4_reaclib -5.00000000000000e-01*rho**2*Y[jn]*Y[jhe4]**2*rate_eval.n_He4_He4_to_d_Li7_derived ) +
          ( + 2*rho*Y[jt]*Y[jli7]*rate_eval.t_Li7_to_n_n_He4_He4_reaclib + -2*2.50000000000000e-01*rho**3*Y[jn]**2*Y[jhe4]**2*rate_eval.n_n_He4_He4_to_t_Li7_derived ) +
          ( +rho*Y[jhe3]*Y[jli7]*rate_eval.He3_Li7_to_n_p_He4_He4_reaclib -5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_He3_Li7_derived ) +
          ( +rho*Y[jt]*Y[jbe7]*rate_eval.t_Be7_to_n_p_He4_He4_reaclib -5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived ) +
          ( -rho**2*Y[jn]*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_Li6_reaclib +Y[jli6]*rate_eval.Li6_to_n_p_He4_derived ) +
          ( -5.00000000000000e-01*rho**2*Y[jn]*Y[jp]**2*rate_eval.n_p_p_to_p_d_reaclib +rho*Y[jp]*Y[jd]*rate_eval.p_d_to_n_p_p_derived )
       )
    ...
    dYdt[jp] = (
          ...
          ( -rho*Y[jp]*Y[jt]*rate_eval.p_t_to_He4_reaclib +Y[jhe4]*rate_eval.He4_to_p_t_derived ) +
          -rho*Y[jp]*Y[jhe3]*rate_eval.p_He3_to_He4_reaclib  +
          ( -rho*Y[jp]*Y[jli6]*rate_eval.p_Li6_to_Be7_reaclib +Y[jbe7]*rate_eval.Be7_to_p_Li6_derived ) +
          ( +5.00000000000000e-01*rho*Y[jd]**2*rate_eval.d_d_to_p_t_reaclib -rho*Y[jp]*Y[jt]*rate_eval.p_t_to_d_d_derived ) +
          ( +rho*Y[jn]*Y[jhe3]*rate_eval.n_He3_to_p_t_reaclib -rho*Y[jp]*Y[jt]*rate_eval.p_t_to_n_He3_derived ) +
          ( +rho*Y[jd]*Y[jhe3]*rate_eval.d_He3_to_p_He4_reaclib -rho*Y[jp]*Y[jhe4]*rate_eval.p_He4_to_d_He3_derived ) +
          ( -rho*Y[jp]*Y[jli6]*rate_eval.p_Li6_to_He4_He3_reaclib +rho*Y[jhe3]*Y[jhe4]*rate_eval.He4_He3_to_p_Li6_derived ) +
          ( +rho*Y[jd]*Y[jli6]*rate_eval.d_Li6_to_p_Li7_reaclib -rho*Y[jp]*Y[jli7]*rate_eval.p_Li7_to_d_Li6_derived ) +
    ...
    dYdt[jd] = (
          ...
          ( -rho*Y[jd]*Y[jhe4]*rate_eval.He4_d_to_Li6_reaclib +Y[jli6]*rate_eval.Li6_to_He4_d_derived ) +
          ( + -2*5.00000000000000e-01*rho*Y[jd]**2*rate_eval.d_d_to_n_He3_reaclib + 2*rho*Y[jn]*Y[jhe3]*rate_eval.n_He3_to_d_d_derived ) +
          ( + -2*5.00000000000000e-01*rho*Y[jd]**2*rate_eval.d_d_to_p_t_reaclib + 2*rho*Y[jp]*Y[jt]*rate_eval.p_t_to_d_d_derived ) +
          ( -rho*Y[jd]*Y[jt]*rate_eval.d_t_to_n_He4_reaclib +rho*Y[jn]*Y[jhe4]*rate_eval.n_He4_to_d_t_derived ) +
          ( -rho*Y[jd]*Y[jhe3]*rate_eval.d_He3_to_p_He4_reaclib +rho*Y[jp]*Y[jhe4]*rate_eval.p_He4_to_d_He3_derived ) +
          ( +rho*Y[jt]*Y[jhe3]*rate_eval.t_He3_to_d_He4_reaclib -rho*Y[jd]*Y[jhe4]*rate_eval.d_He4_to_t_He3_derived ) +
          ( -rho*Y[jd]*Y[jli6]*rate_eval.d_Li6_to_n_Be7_reaclib +rho*Y[jn]*Y[jbe7]*rate_eval.n_Be7_to_d_Li6_derived ) +
          ( -rho*Y[jd]*Y[jli6]*rate_eval.d_Li6_to_p_Li7_reaclib +rho*Y[jp]*Y[jli7]*rate_eval.p_Li7_to_d_Li6_derived ) +
          ( -rho*Y[jd]*Y[jli7]*rate_eval.d_Li7_to_n_He4_He4_reaclib +5.00000000000000e-01*rho**2*Y[jn]*Y[jhe4]**2*rate_eval.n_He4_He4_to_d_Li7_derived ) +
          ( -rho*Y[jd]*Y[jbe7]*rate_eval.d_Be7_to_p_He4_He4_reaclib +5.00000000000000e-01*rho**2*Y[jp]*Y[jhe4]**2*rate_eval.p_He4_He4_to_d_Be7_derived ) +
    ...
    dYdt[jt] = (
          ...
          ( +rho*Y[jn]*Y[jd]*rate_eval.n_d_to_t_reaclib -Y[jt]*rate_eval.t_to_n_d_derived ) +
          ( -rho*Y[jp]*Y[jt]*rate_eval.p_t_to_He4_reaclib +Y[jhe4]*rate_eval.He4_to_p_t_derived ) +
          ( -rho*Y[jt]*Y[jhe4]*rate_eval.He4_t_to_Li7_reaclib +Y[jli7]*rate_eval.Li7_to_He4_t_derived ) +
          ( +5.00000000000000e-01*rho*Y[jd]**2*rate_eval.d_d_to_p_t_reaclib -rho*Y[jp]*Y[jt]*rate_eval.p_t_to_d_d_derived ) +
          ( -rho*Y[jd]*Y[jt]*rate_eval.d_t_to_n_He4_reaclib +rho*Y[jn]*Y[jhe4]*rate_eval.n_He4_to_d_t_derived ) +
          ( +rho*Y[jn]*Y[jhe3]*rate_eval.n_He3_to_p_t_reaclib -rho*Y[jp]*Y[jt]*rate_eval.p_t_to_n_He3_derived ) +
          ( -rho*Y[jt]*Y[jhe3]*rate_eval.t_He3_to_d_He4_reaclib +rho*Y[jd]*Y[jhe4]*rate_eval.d_He4_to_t_He3_derived ) +
          ...
          ( + -2*5.00000000000000e-01*rho*Y[jt]**2*rate_eval.t_t_to_n_n_He4_reaclib + 2*5.00000000000000e-01*rho**2*Y[jn]**2*Y[jhe4]*rate_eval.n_n_He4_to_t_t_derived ) +
          ( -rho*Y[jt]*Y[jhe3]*rate_eval.t_He3_to_n_p_He4_reaclib +rho**2*Y[jn]*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived ) +
          ( -rho*Y[jt]*Y[jli7]*rate_eval.t_Li7_to_n_n_He4_He4_reaclib +2.50000000000000e-01*rho**3*Y[jn]**2*Y[jhe4]**2*rate_eval.n_n_He4_He4_to_t_Li7_derived ) +
          ( -rho*Y[jt]*Y[jbe7]*rate_eval.t_Be7_to_n_p_He4_He4_reaclib +5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived )
       )
    ...
    dYdt[jhe4] = (
          ...
          ( + 2*rho*Y[jn]*Y[jbe7]*rate_eval.n_Be7_to_He4_He4_reaclib + -2*5.00000000000000e-01*rho*Y[jhe4]**2*rate_eval.He4_He4_to_n_Be7_derived ) +
          ( +5.00000000000000e-01*rho*Y[jt]**2*rate_eval.t_t_to_n_n_He4_reaclib -5.00000000000000e-01*rho**2*Y[jn]**2*Y[jhe4]*rate_eval.n_n_He4_to_t_t_derived ) +
          ( +rho*Y[jt]*Y[jhe3]*rate_eval.t_He3_to_n_p_He4_reaclib -rho**2*Y[jn]*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived ) +
          ...
          ( + 2*rho*Y[jd]*Y[jli7]*rate_eval.d_Li7_to_n_He4_He4_reaclib + -2*5.00000000000000e-01*rho**2*Y[jn]*Y[jhe4]**2*rate_eval.n_He4_He4_to_d_Li7_derived ) +
          ...
          ( + 2*rho*Y[jt]*Y[jli7]*rate_eval.t_Li7_to_n_n_He4_He4_reaclib + -2*2.50000000000000e-01*rho**3*Y[jn]**2*Y[jhe4]**2*rate_eval.n_n_He4_He4_to_t_Li7_derived ) +
          ( + 2*rho*Y[jhe3]*Y[jli7]*rate_eval.He3_Li7_to_n_p_He4_He4_reaclib + -2*5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_He3_Li7_derived ) +
          ( + 2*rho*Y[jt]*Y[jbe7]*rate_eval.t_Be7_to_n_p_He4_He4_reaclib + -2*5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived ) +
          ( + 2*rho*Y[jhe3]*Y[jbe7]*rate_eval.He3_Be7_to_p_p_He4_He4_reaclib + -2*2.50000000000000e-01*rho**3*Y[jp]**2*Y[jhe4]**2*rate_eval.p_p_He4_He4_to_He3_Be7_derived ) +
          ( -rho**2*Y[jn]*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_Li6_reaclib +Y[jli6]*rate_eval.Li6_to_n_p_He4_derived )
       )
...
def jacobian_eq(t, Y, rho, T, screen_func):
    ...
    jac[jn, jn] = (
       ...
       -rho*Y[jhe3]*rate_eval.n_He3_to_d_d_derived
       -rho*Y[jhe4]*rate_eval.n_He4_to_d_t_derived
       -rho*Y[jbe7]*rate_eval.n_Be7_to_d_Li6_derived
       -2*5.00000000000000e-01*rho**2*2*Y[jn]*Y[jhe4]*rate_eval.n_n_He4_to_t_t_derived
       -rho**2*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived
       -5.00000000000000e-01*rho**2*Y[jhe4]**2*rate_eval.n_He4_He4_to_d_Li7_derived
       -2*2.50000000000000e-01*rho**3*2*Y[jn]*Y[jhe4]**2*rate_eval.n_n_He4_He4_to_t_Li7_derived
       -5.00000000000000e-01*rho**3*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_He3_Li7_derived
       -5.00000000000000e-01*rho**3*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived
       )
    ...
    jac[jn, jp] = (
       ...
       -rho**2*Y[jn]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived
       -5.00000000000000e-01*rho**3*Y[jn]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_He3_Li7_derived
       -5.00000000000000e-01*rho**3*Y[jn]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived
       +rho*Y[jt]*rate_eval.p_t_to_n_He3_derived
       +rho*Y[jli7]*rate_eval.p_Li7_to_n_Be7_derived
       +rho*Y[jd]*rate_eval.p_d_to_n_p_p_derived
       )
    ...
    jac[jn, jd] = (
       ...
       +rate_eval.d_to_n_p_derived
       +rho*Y[jp]*rate_eval.p_d_to_n_p_p_derived
       )
    ...
    jac[jn, jt] = (
       ...
       +rate_eval.t_to_n_d_derived
       +rho*Y[jp]*rate_eval.p_t_to_n_He3_derived
       +rho*Y[jhe4]*rate_eval.He4_t_to_n_Li6_derived
       )

    jac[jn, jhe3] = (
       -rho*Y[jn]*rate_eval.n_He3_to_He4_reaclib
       -rho*Y[jn]*rate_eval.n_He3_to_p_t_reaclib
       -rho*Y[jn]*rate_eval.n_He3_to_d_d_derived
    ...
    jac[jn, jhe4] = (
       ...
       -rho*Y[jn]*rate_eval.n_He4_to_d_t_derived
       -2*5.00000000000000e-01*rho**2*Y[jn]**2*rate_eval.n_n_He4_to_t_t_derived
       -rho**2*Y[jn]*Y[jp]*rate_eval.n_p_He4_to_t_He3_derived
       -5.00000000000000e-01*rho**2*Y[jn]*2*Y[jhe4]*rate_eval.n_He4_He4_to_d_Li7_derived
       -2*2.50000000000000e-01*rho**3*Y[jn]**2*2*Y[jhe4]*rate_eval.n_n_He4_He4_to_t_Li7_derived
       -5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*2*Y[jhe4]*rate_eval.n_p_He4_He4_to_He3_Li7_derived
       -5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*2*Y[jhe4]*rate_eval.n_p_He4_He4_to_t_Be7_derived
       +rate_eval.He4_to_n_He3_derived
       +rho*Y[jt]*rate_eval.He4_t_to_n_Li6_derived
       +5.00000000000000e-01*rho*2*Y[jhe4]*rate_eval.He4_He4_to_n_Be7_derived
       )
    ...
    jac[jn, jli6] = (
       ...
       +rate_eval.Li6_to_n_p_He4_derived
       )
    ...
    jac[jn, jli7] = (
       ...
       +rate_eval.Li7_to_n_Li6_derived
       +rho*Y[jp]*rate_eval.p_Li7_to_n_Be7_derived
       )

    jac[jn, jbe7] = (
       -rho*Y[jn]*rate_eval.n_Be7_to_p_Li7_reaclib
       -rho*Y[jn]*rate_eval.n_Be7_to_He4_He4_reaclib
       -rho*Y[jn]*rate_eval.n_Be7_to_d_Li6_derived
    ...
    jac[jp, jp] = (
       ...
       -rho*Y[jt]*rate_eval.p_t_to_d_d_derived
       -rho*Y[jt]*rate_eval.p_t_to_n_He3_derived
       -rho*Y[jhe4]*rate_eval.p_He4_to_d_He3_derived
       -rho*Y[jli7]*rate_eval.p_Li7_to_d_Li6_derived
       -rho*Y[jli7]*rate_eval.p_Li7_to_n_Be7_derived
       -rho**2*Y[jn]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived
       ...
       -rho*Y[jd]*rate_eval.p_d_to_n_p_p_derived
       +5.00000000000000e-01*rho**2*Y[jn]*2*Y[jp]*rate_eval.n_p_p_to_p_d_reaclib
       +2*rho*Y[jd]*rate_eval.p_d_to_n_p_p_derived
       )
    ...
    jac[jp, jd] = (
       ...
       +rate_eval.d_to_n_p_derived
       +2*rho*Y[jp]*rate_eval.p_d_to_n_p_p_derived
       )

    jac[jp, jt] = (
       -rho*Y[jp]*rate_eval.p_t_to_He4_reaclib
       -rho*Y[jp]*rate_eval.p_t_to_d_d_derived
       -rho*Y[jp]*rate_eval.p_t_to_n_He3_derived
       +rho*Y[jhe3]*rate_eval.t_He3_to_n_p_He4_reaclib
       +rho*Y[jbe7]*rate_eval.t_Be7_to_n_p_He4_He4_reaclib
       )
    ...
    jac[jp, jhe3] = (
       ...
       +rho*Y[jhe4]*rate_eval.He4_He3_to_p_Li6_derived
       )
    ...
    jac[jp, jhe4] = (
       ...
       +rate_eval.He4_to_p_t_derived
       +rho*Y[jhe3]*rate_eval.He4_He3_to_p_Li6_derived
    ...
    jac[jp, jli7] = (
       ...
       -rho*Y[jp]*rate_eval.p_Li7_to_d_Li6_derived
       -rho*Y[jp]*rate_eval.p_Li7_to_n_Be7_derived
       +rho*Y[jhe3]*rate_eval.He3_Li7_to_n_p_He4_He4_reaclib
       )
    ...
    jac[jp, jbe7] = (
       ...
       +rate_eval.Be7_to_p_Li6_derived
       )
    ...
    jac[jd, jn] = (
       ...
       +rho*Y[jp]*rate_eval.n_p_to_d_reaclib
       +5.00000000000000e-01*rho**2*Y[jp]**2*rate_eval.n_p_p_to_p_d_reaclib
       +2*rho*Y[jhe3]*rate_eval.n_He3_to_d_d_derived
       +rho*Y[jhe4]*rate_eval.n_He4_to_d_t_derived
       +rho*Y[jbe7]*rate_eval.n_Be7_to_d_Li6_derived
       +5.00000000000000e-01*rho**2*Y[jhe4]**2*rate_eval.n_He4_He4_to_d_Li7_derived
       )
    ...
    jac[jd, jp] = (
       ...
       +5.00000000000000e-01*rho**2*Y[jn]*2*Y[jp]*rate_eval.n_p_p_to_p_d_reaclib
       +2*rho*Y[jt]*rate_eval.p_t_to_d_d_derived
       +rho*Y[jhe4]*rate_eval.p_He4_to_d_He3_derived
       +rho*Y[jli7]*rate_eval.p_Li7_to_d_Li6_derived
       +5.00000000000000e-01*rho**2*Y[jhe4]**2*rate_eval.p_He4_He4_to_d_Be7_derived
       )
    ...
    jac[jd, jd] = (
       ...
       -rho*Y[jbe7]*rate_eval.d_Be7_to_p_He4_He4_reaclib
       -rate_eval.d_to_n_p_derived
       -rho*Y[jhe4]*rate_eval.d_He4_to_t_He3_derived
       -rho*Y[jp]*rate_eval.p_d_to_n_p_p_derived
       )
    ...
    jac[jd, jt] = (
       ...
       +rate_eval.t_to_n_d_derived
       +2*rho*Y[jp]*rate_eval.p_t_to_d_d_derived
       )
    ...
    jac[jd, jhe3] = (
       ...
       +rate_eval.He3_to_p_d_derived
       +2*rho*Y[jn]*rate_eval.n_He3_to_d_d_derived
       )

    jac[jd, jhe4] = (
       -rho*Y[jd]*rate_eval.He4_d_to_Li6_reaclib
       -rho*Y[jd]*rate_eval.d_He4_to_t_He3_derived
    ...
    jac[jd, jli6] = (
       -rho*Y[jd]*rate_eval.d_Li6_to_n_Be7_reaclib
       -rho*Y[jd]*rate_eval.d_Li6_to_p_Li7_reaclib
       +rate_eval.Li6_to_He4_d_derived
       )
    ...
    jac[jt, jn] = (
       ...
       +2*5.00000000000000e-01*rho**2*2*Y[jn]*Y[jhe4]*rate_eval.n_n_He4_to_t_t_derived
       +rho**2*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived
       +2.50000000000000e-01*rho**3*2*Y[jn]*Y[jhe4]**2*rate_eval.n_n_He4_He4_to_t_Li7_derived
       +5.00000000000000e-01*rho**3*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived
       )
    ...
    jac[jt, jhe4] = (
       ...
       +2*5.00000000000000e-01*rho**2*Y[jn]**2*rate_eval.n_n_He4_to_t_t_derived
       +rho**2*Y[jn]*Y[jp]*rate_eval.n_p_He4_to_t_He3_derived
       +2.50000000000000e-01*rho**3*Y[jn]**2*2*Y[jhe4]*rate_eval.n_n_He4_He4_to_t_Li7_derived
       +5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*2*Y[jhe4]*rate_eval.n_p_He4_He4_to_t_Be7_derived
       )
    ...
    jac[jt, jli7] = (
       ...
       +rate_eval.Li7_to_He4_t_derived
       )
    ...
    jac[jhe4, jn] = (
       -rho**2*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_Li6_reaclib
       -rho*Y[jhe4]*rate_eval.n_He4_to_d_t_derived
       -5.00000000000000e-01*rho**2*2*Y[jn]*Y[jhe4]*rate_eval.n_n_He4_to_t_t_derived
       -rho**2*Y[jp]*Y[jhe4]*rate_eval.n_p_He4_to_t_He3_derived
       -2*5.00000000000000e-01*rho**2*Y[jhe4]**2*rate_eval.n_He4_He4_to_d_Li7_derived
       -2*2.50000000000000e-01*rho**3*2*Y[jn]*Y[jhe4]**2*rate_eval.n_n_He4_He4_to_t_Li7_derived
       -2*5.00000000000000e-01*rho**3*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_He3_Li7_derived
       -2*5.00000000000000e-01*rho**3*Y[jp]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived
       +rho*Y[jhe3]*rate_eval.n_He3_to_He4_reaclib
       +rho*Y[jli6]*rate_eval.n_Li6_to_He4_t_reaclib
    ...
    jac[jhe4, jp] = (
       ...
       -2*5.00000000000000e-01*rho**3*Y[jn]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_He3_Li7_derived
       -2*5.00000000000000e-01*rho**3*Y[jn]*Y[jhe4]**2*rate_eval.n_p_He4_He4_to_t_Be7_derived
       -2*2.50000000000000e-01*rho**3*2*Y[jp]*Y[jhe4]**2*rate_eval.p_p_He4_He4_to_He3_Be7_derived
       +rho*Y[jt]*rate_eval.p_t_to_He4_reaclib
       +rho*Y[jhe3]*rate_eval.p_He3_to_He4_reaclib
       +rho*Y[jli6]*rate_eval.p_Li6_to_He4_He3_reaclib
    ...
    jac[jhe4, jhe4] = (
       ...
       -2*5.00000000000000e-01*rho*2*Y[jhe4]*rate_eval.He4_He4_to_n_Be7_derived
       -5.00000000000000e-01*rho**2*Y[jn]**2*rate_eval.n_n_He4_to_t_t_derived
       -rho**2*Y[jn]*Y[jp]*rate_eval.n_p_He4_to_t_He3_derived
       -5.00000000000000e-01*rho**2*Y[jp]**2*rate_eval.p_p_He4_to_He3_He3_derived
       -2*5.00000000000000e-01*rho**2*Y[jn]*2*Y[jhe4]*rate_eval.n_He4_He4_to_d_Li7_derived
       -2*5.00000000000000e-01*rho**2*Y[jp]*2*Y[jhe4]*rate_eval.p_He4_He4_to_d_Be7_derived
       -2*2.50000000000000e-01*rho**3*Y[jn]**2*2*Y[jhe4]*rate_eval.n_n_He4_He4_to_t_Li7_derived
       -2*5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*2*Y[jhe4]*rate_eval.n_p_He4_He4_to_He3_Li7_derived
       -2*5.00000000000000e-01*rho**3*Y[jn]*Y[jp]*2*Y[jhe4]*rate_eval.n_p_He4_He4_to_t_Be7_derived
       -2*2.50000000000000e-01*rho**3*Y[jp]**2*2*Y[jhe4]*rate_eval.p_p_He4_He4_to_He3_Be7_derived
       )
